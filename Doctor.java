...
interface DoctorDetails {
	...
	static LinkedHashMap<String, LinkedHashMap<String, Integer>> diseaseDesc() throws Exception {
		File file = new File("C:\\Users\\HP\\Desktop\\JavaBasics\\ProjectMain\\DiseaseDesc.lookup");
...
public class Doctor extends Authentication implements DoctorDetails {
	...
	public void updatePatientDetails(int id, String doctorName, String isBilled) {
		try {
			FileReader fr = new FileReader("C:\\Users\\HP\\Desktop\\JavaBasics\\ProjectOutputFiles\\dbCredentials.properties");
			Properties prop = new Properties();
			prop.load(fr);
			
			Class.forName("com.mysql.cj.jdbc.Driver");
			Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/"+prop.getProperty("dbName"), prop.getProperty("root"), prop.getProperty("password"));
